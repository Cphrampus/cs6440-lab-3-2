...
function displayAnnotation(annotation) {
  note.innerHTML = `${annotation.time},${annotation.authorString || annotation.author.authorString},${annotation.text}`;
}
...
client.request(`/MedicationRequest?patient=${client.patient.id}`, {
  ...
  function addWeightAnnotation() {
    ...
    author = {authorString: "cphrampus3" };

    var annotation = {author, time, text};
